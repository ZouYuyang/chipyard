...
class CORDICBOOMV4Config extends Config(
  new chipyard.config.WithCORDICAccel ++
  new boom.v4.common.WithNSmallBooms(1) ++
  new chipyard.config.AbstractConfig
)
